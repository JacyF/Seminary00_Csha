// Домашняя работа. Задача 38. 
// Задайте массив вещественных чисел.
// Найдите разницу между максимальным и 
// минимальным числами массива

// [3.5, 7.1, 22.9, 2.3, 78.5] -> 76.2

double[] NewRandowDouble(int siz, int min, int max)
{
...
Console.Write(@$"Разницу между максимальным и минимальным элементами  --->
{Math.Round(result, 2)}");
